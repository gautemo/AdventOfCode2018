...
rl.on('line', (line) => {
    ...
    for (let c of line) {
        if (c === '-')
            ...
            trackRow.push(Track.CurveRight);
        else if (c === '\\')
            trackRow.push(Track.CurveLeft);
        else if (c === '+')
            trackRow.push(Track.Intersection);
        else if (c === '<') {
            trackRow.push(Track.Flat);
...
var Track;
(function (Track) {
    Track[Track["Flat"] = 0] = "Flat";
    Track[Track["UpDown"] = 1] = "UpDown";
    Track[Track["CurveRight"] = 2] = "CurveRight";
    Track[Track["CurveLeft"] = 3] = "CurveLeft";
    Track[Track["Intersection"] = 4] = "Intersection";
    Track[Track["NoTrack"] = 5] = "NoTrack";
})(Track || (Track = {}));
class Cart {
    constructor(id, dir, x, y) {
        this.turns = [Direction.Left, Direction.Up, Direction.Right];
        this.id = id;
        this.dir = dir;
        this.x = x;
        this.y = y;
